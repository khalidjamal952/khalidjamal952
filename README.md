...
- I'm a self-driven frontend developer with a passion for building clean and responsive web interfaces.  
Currently pursuing **B.Tech in Computer Science**, and actively exploring **React.js** and modern JavaScript.

🔧 Tech Stack:
- HTML, CSS, JavaScript (ES6+)
- React.js, Bootstrap, Tailwind CSS
- Git & GitHub
- 💡 *Open to internship opportunities and frontend collaborations!*
